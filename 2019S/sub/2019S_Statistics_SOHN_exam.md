...
* The following implies that the correlation coefficient between x and y indicates how much the outcome variable y changes as the unit of standard deviation of y given the unit change of standard deviation of x. <img src="img/eq1.png" width="500"/>
